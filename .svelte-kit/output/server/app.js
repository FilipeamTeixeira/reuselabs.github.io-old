...
const css$8 = {
  ...
  map: `{"version":3,"file":"navbar.svelte","sources":["navbar.svelte"],"sourcesContent":["<script>\\n    \\timport { page } from '$app/stores';\\n<\/script>\\n\\n<!-- uk-sticky=\\"animation: uk-animation-slide-top; sel-target: .uk-navbar-container; cls-active: uk-navbar-sticky uk-light; cls-inactive: uk-navbar-transparent; top: 200\\" -->\\n\\n<nav class=\\"uk-navbar uk-navbar-transparent\\">\\n    <div class=\\"uk-navbar-center\\">\\n        <div class = \\"uk-navbar-item\\"> \\n        <span style = \\"font-size:20px; font-weight:100;\\"> ReUSe </span>\\n        <span style = \\"font-size:20px; font-weight:300;\\">Labs</span>\\n        </div>   \\n    </div>\\n\\n    <div class=\\"uk-navbar-left\\">\\n        <ul class=\\"uk-navbar-nav uk-visible@m\\">\\n            <li class:active={$page.path === '/'}><a sveltekit:prefetch href=\\"/\\">Home</a></li>\\n        </ul>\\n\\n        <div class=\\"uk-navbar-item uk-visible@m\\">\\n        </div>\\n    </div>\\n\\n    <div class=\\"uk-navbar-right\\">\\n        <ul class=\\"uk-navbar-nav uk-visible@m\\">\\n            <li class:active={$page.path === '/faqs'}><a sveltekit:prefetch href=\\"/faqs\\">FAQ</a></li>\\n            <li class:active={$page.path === '/about_us'}><a sveltekit:prefetch href=\\"/about_us\\">About Us</a></li>\\n        </ul>\\n        <!-- svelte-ignore a11y-missing-content -->\\n        <a class=\\"uk-navbar-toggle uk-hidden@m\\" href=\\"#offcanvas\\" uk-toggle style = \\"font-size:25px; font-weight:300;\\">\u2261</a>\\n    </div>\\n</nav>\\n\\n<style>\\n\\n.uk-navbar-nav > li > a {\\n    color:rgb(79, 79, 79);\\n}\\n\\n.uk-navbar-nav > li:hover > a,\\n.uk-navbar-nav > li > a:focus,\\n.uk-navbar-nav > li.uk-open > a {\\n    color: #005599;\\n}\\n\\nspan{\\n    display: inline-block;\\n    margin-right: -3px;\\n}\\n\\n</style>"],"names":[],"mappings":"AAmCA,6BAAc,CAAG,iBAAE,CAAG,CAAC,eAAC,CAAC,AACrB,MAAM,IAAI,EAAE,CAAC,CAAC,EAAE,CAAC,CAAC,EAAE,CAAC,AACzB,CAAC,AAED,6BAAc,CAAG,iBAAE,MAAM,CAAG,gBAAC,CAC7B,6BAAc,CAAG,iBAAE,CAAG,gBAAC,MAAM,AACG,CAAC,AAC7B,KAAK,CAAE,OAAO,AAClB,CAAC,AAED,iDAAI,CAAC,AACD,OAAO,CAAE,YAAY,CACrB,YAAY,CAAE,IAAI,AACtB,CAAC"}`
};
...
<nav class="${"uk-navbar uk-navbar-transparent"}"><div class="${"uk-navbar-center"}"><div class="${"uk-navbar-item"}"><span style="${"font-size:20px; font-weight:100;"}" class="${"svelte-12cby6h"}">ReUSe </span>
        <span style="${"font-size:20px; font-weight:300;"}" class="${"svelte-12cby6h"}">Labs</span></div></div>

    <div class="${"uk-navbar-left"}"><ul class="${"uk-navbar-nav uk-visible@m svelte-12cby6h"}"><li class="${["svelte-12cby6h", $page.path === "/" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/"}" class="${"svelte-12cby6h"}">Home</a></li></ul>
